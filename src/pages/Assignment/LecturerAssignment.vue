<template>
    <div class="container">
        ...
        <div class="button-group">
            <button @click="startNewAssignment" class="button">
                Create New Assignment
            </button>
        </div>

        <form v-if="showForm" @submit.prevent="saveToAssignmentList" class="form">
            <input v-model="newAssignment.name" placeholder="Name" class="input"
                :class="{ 'is-invalid': !validName }" /><br />
            <div class="input-group">
                <input type="datetime-local" v-model="newAssignment.set_time" placeholder="Set Date" class="input"
                    :class="{ 'is-invalid': !validSetTime }" />
                <button type="button" @click="setCurrentTime" class="button small-button">
                    Set Current Time
                </button>
            </div>
            <input type="datetime-local" v-model="newAssignment.due_date" placeholder="Due Date" class="input"
                :class="{ 'is-invalid': !validDueDate }" /><br />
            <input v-model="newAssignment.description" placeholder="Description" class="input"
                :class="{ 'is-invalid': !validDescription }" /><br />
        ...
        <div class="assignment-list">
            <div v-for="assignment in Assignment" :key="assignment.id" class="assignment-item">
                ...
                <div class="assignment-actions">
                    <button @click="editAssignment(assignment)" class="button small-button">
                        Edit
                    </button>
                    <button @click="deleteAssignment(assignment.id)" class="button small-button delete-button">
                        Delete
                    </button>
                </div>
            </div>
    ...
    computed: {
        calculatedRemainingTime() {
            return this.calculateRemainingTime(
                this.newAssignment.set_time,
                this.newAssignment.due_date,
            );
        },
        validName() {
